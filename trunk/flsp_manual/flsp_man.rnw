...
object of class $DEoptim.control$ to set the the optimising parameters. See
the help page for $DEoptim.control$ for more details.
...
WHY? HOPE MODEL IS OK...!

%nzrl2 <- nzrl
%params(nzrl2)[,] <- c(0.0659,129000)
%ll(nzrl2)
%
