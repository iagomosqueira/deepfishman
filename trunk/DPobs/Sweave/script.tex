...
The mean across years is represented by the fitted red line $\hat{CV}[\hat{I}] = \alpha E ^ \beta$, where $alpha=3.93$ and
$\beta = -0.5$.}
\label{fig:effCV}
\end{figure} 
...
iter    0 value -217.395083
final  value -217.395083 
converged
iter:  1 
Running SANN
Running Other Method
iter    0 value -222.200109
final  value -222.200109 
converged
iter:  1 
Running SANN
Running Other Method
iter    0 value -226.324683
final  value -226.324683 
converged
iter:  1 
Running SANN
Running Other Method
iter    0 value -229.871225
final  value -229.871225 
converged
\end{Soutput}
\end{Schunk}
